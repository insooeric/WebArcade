  ...
  return (
    <div className="error-page">
              ...
              <div className="col-sm-10 col-sm-offset-1  text-center">
                ...
                <div className="contant_box_404">
                  ...
                  <a
                    href="/"
                    className="link_404"
                    onClick={sessionStorage.setItem("activeRoute", "/")}
                  >
                    Go to Home
                  </a>
                </div>
      ...
      <p className="center">
        Hi, user.
        <br />
        {/* <br /> Use <span className="label label-danger">Space</span> to shoot
        and <span className="label label-danger">←</span>&#160;
        <span className="label label-danger">→</span> to move!&#160;&#160;&#160; */}
        If you are seeing this page, it means this page apparently does not
        exists. <br />
        Move: ← → Shoot: space
